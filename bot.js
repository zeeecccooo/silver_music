...
let ownerID = "487729062291177485";
...
client.login("NTU1NzMyMTk5NTA1MTMzNTcy.D2veuA.oZj8-H54jpPvXUGNPb8UD015yeU");
...
client.on('message', message => {
  ...
  if (message.content === 'qpremiumjoin2') {
	   if (message.author.id !== '487729062291177485') return message.reply(':no_entry: | This Command Only For Premium  :fire: !')
 if(!message.author.id === '487729062291177485') return;
    if (message.member.voiceChannel) {
      message.member.voiceChannel.join()
        .then(connection => { 
          message.reply('لقد دخلت الروم بنجاح !');
